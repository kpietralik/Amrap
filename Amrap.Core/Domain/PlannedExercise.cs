...
public class PlannedExercise
{
    ...
    public static PlannedExercise FromModel(PlannedExerciseModel model, ExerciseType exerciseType)
    {
        ...
        return new(model.Guid, exerciseType, model.Sets, model.Reps, model.Weight, model.Note, model.DropSet, model.ToFailure);
    }

    private PlannedExercise(string guid, ExerciseType exerciseType, int sets, int reps, float weight, string note, bool dropSet, bool toFailure)
    {
        Guid = guid;
